/* =====================================================
   ANDES CONSTRUCCIONES · HORARIOS — app.js (DEMO)
   Estructura del Sheet esperada (por obra):
...
// ── CONFIGURACIÓN ──────────────────────────────────────
const SUCURSALES = [
  { id: '01',     hoja: 'OBRANORTE', nombre: 'OBRA NORTE',   color: '#185FA5', colorLight: '#DBEAFE' },
  { id: '05',     hoja: 'OBRACOSTA', nombre: 'OBRA COSTA',   color: '#0F6E56', colorLight: '#D1FAE5' },
  { id: '09',     hoja: 'OBRACENTRO',nombre: 'OBRA CENTRO',  color: '#B45309', colorLight: '#FEF3C7' },
  { id: '10',     hoja: 'OBRARUTA',  nombre: 'OBRA RUTA 22', color: '#9B2563', colorLight: '#FCE7F3' },
  { id: '12',     hoja: 'OBRASUR',   nombre: 'OBRA SUR',     color: '#534AB7', colorLight: '#EDE9FE' },
  { id: '14',     hoja: 'OBRAALTOS', nombre: 'OBRA ALTOS',   color: '#3B6D11', colorLight: '#D1FAE5' },
  { id: 'DEPO',   hoja: 'DEPO',      nombre: 'DEPÓSITO',     color: '#475569', colorLight: '#F1F5F9' },
...
// ── EMPRESAS ───────────────────────────────────────────
const EMPRESAS = ['ANDES CONSTRUCCIONES SRL', 'PATAGONIA OBRAS SA'];
...
const APPS_SCRIPT_URL = 'https://script.google.com/macros/s/DEMO-ANDES-CONSTRUCCIONES/exec';
...
function generarDemoData() {
  const empleados = {
    '01': ['Martín Pérez','Diego Soto','Hugo Ramírez','Walter Núñez','Cristian Ibáñez'],
    '05': ['Sergio Funes','Pablo Aguirre','Damián Ríos','Nicolás Vega'],
    '09': ['Gustavo Molina','Rubén Cáceres','Esteban Paz'],
    '10': ['Mauricio Lima','Federico Ortiz','Adrián Bravo'],
    '12': ['Lucas Medina','Ezequiel Rojas','Tomás Salinas'],
    '14': ['Joaquín Acosta','Franco Bustos','Iván Correa'],
  };
  const turnos = [
...
function descargarExcelEmpleado(nombreEmp, nomMostrar, sucNombre) {
  ...
  const fileName = `ANDES_${nomMostrar.replace(/\s+/g,'_')}.xlsx`;
...
function mostrarLoginApp() {
  ...
  location.href = 'https://chavezleonardo24-beep.github.io/andes-login-demo/';
}
  ...
  loginEl.innerHTML = `
    <div class="login-card">
      <div class="login-logo">
        <img src="andes_logo.svg" alt="Andes" class="login-tridente" onerror="this.style.display='none'" />
        <span class="login-brand">ANDES</span>
      </div>
      ...
      <div class="login-footer">Sistema interno · Andes Construcciones (Demo)</div>
    </div>
  `;
...
<body>
  <div class="print-header">
    <div>
      <div class="print-brand">ANDES</div>
...
function descargarICS(ev) {
  ...
  const ics = [
    'BEGIN:VCALENDAR',
    'VERSION:2.0',
    'PRODID://Andes Construcciones//ES',
    'BEGIN:VEVENT',
